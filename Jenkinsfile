            ...
            steps {
                container ('gcp-sdk'){
                    script{
                        ...
                        sh ' curl -X POST -T /home/jenkins/agent/workspace/mysql-test/query.json \
    -H "Authorization: Bearer ${bearerToken}" \
    -H "Content-Type: application/json" \
    "https://storage.googleapis.com/upload/storage/v1/b/tjohns-mysql-dump/o?uploadType=media&name=query.json"
